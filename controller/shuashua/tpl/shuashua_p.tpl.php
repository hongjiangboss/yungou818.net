...
<div style="width:100%; height:800px;">
	...
	<label style="font-size:12px; color:#F53D38;">自动购买时间间隔已经统一调整至最佳，由于自行调整对服务器资源消耗大，因此取消自由设定。</label>
	</div>
	<div class="div">
		自动购买用户id：
	...
	<div >
		<span style="color:#FF0000;">*</span> <span style="color:#CC6633;">自动购买时段：</span><span><?php echo $timeperiod; ?></span>
		<table id="table">
		<?php for($i=0;$i<24;$i++){ ?>
				<?php if($i%6 ==0){ ?>	
						<tr class="tr">
	...
	<div class="div">自动购买商品：<label id="shopid"><?php echo $shopid; ?></label></div>
	...
	<div style="width:100%; ">
		...
		<div style="width:100%;">
			...
			<a href="<?php echo WEB_PATH.'/shuashua/shuashua_p/show/'.$o_p;?>">
				<input type="button" value="上一页" />
			</a>&nbsp;
			<a href="<?php  echo WEB_PATH.'/shuashua/shuashua_p/show/'.$n_p;?>">
...
$(function(){
	$("#start_auto_p").click(function(){
		...
		$.ajax({
			url:"<?php echo WEB_PATH.'/shuashua/shuashua_p/ajaxaction';?>",
			type:"POST",
	...
	$("#stop_auto_p").click(function(){
		$.ajax({
			url:"<?php echo WEB_PATH.'/shuashua/shuashua_p/stop';?>",
			type:"POST",
			success:function(data){
				//alert(data);
			}
	...
	if(isstop == 0){
		$.ajax({
			url:"<?php echo WEB_PATH.'/shuashua/shuashua_p/errorrestart/';?>",
			type:"POST",
			success:function(data){
			}
		});
