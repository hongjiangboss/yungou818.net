...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/data/uploads/shaidan/',
            'upload_url' => $this->get_full_url().'/data/uploads/shaidan/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file = new \stdClass();
        $name = mb_ereg_replace('[^0-9]', '0', $name);
    ...
    protected function download() {
        ...
        $this->header('Last-Modified8 '.gmdate('D, d M Y H:i:s T', filemtime($file_path)));
