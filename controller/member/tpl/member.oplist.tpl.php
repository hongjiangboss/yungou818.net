  ...
  <table width="100%" cellspacing="0">
    <thead>
		<tr>
            ...
            <th width="100px" align="center">变化</th>
            <th width="100px" align="center">操作前</th>
			 <th width="100px" align="center">操作后</th>
    ...
    <tbody>
		...
		<tr>
			...
			<td align="center"><?php echo $recharge[$j]['deltamoney']; ?></td>	
			<td align="center"><?php echo $recharge[$j]['premoney']; ?></td>	
