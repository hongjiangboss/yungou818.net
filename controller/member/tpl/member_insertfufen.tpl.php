...
<form name="myform" action="" method="post" enctype="multipart/form-data">
  <table width="100%" cellspacing="0">
  	 <tr>
		...
		<tr>
			<td width="120" align="right">佣金开关：</td>
			<td>
				<input type="radio" name="yongjin_on" value="1" <?php echo $config['yongjin_on'] ? 'checked' : '';?>>开
				<input type="radio" name="yongjin_on" value="0" <?php echo $config['yongjin_on'] ? '' : 'checked';?>>关
			</td>
		</tr>
		<tr>
			<td width="120" align="right">1级佣金返回：</td>
			<td>
				<input type="text" name="fufen_yongjin_o" maxlength="4" value="<?php echo $config['fufen_yongjin_o'];?>" class="input-text">&nbsp;&nbsp;&nbsp;&nbsp;备注：被邀请1级好友每消费一元所产生的佣金返回给邀请者！
			</td>
		</tr>
		<tr>
			<td width="120" align="right">2级佣金返回：</td>
			<td>
				<input type="text" name="fufen_yongjin_w" maxlength="4" value="<?php echo $config['fufen_yongjin_w'];?>" class="input-text">&nbsp;&nbsp;&nbsp;&nbsp;备注：被邀请2级好友每消费一元所产生的佣金返回给邀请者！
			</td>
		</tr>
		<tr>
			<td width="120" align="right">3级佣金返回：</td>
			<td>
				<input type="text" name="fufen_yongjin_t" maxlength="4" value="<?php echo $config['fufen_yongjin_t'];?>" class="input-text">&nbsp;&nbsp;&nbsp;&nbsp;备注：被邀请3级好友每消费一元所产生的佣金返回给邀请者！
			</td>
