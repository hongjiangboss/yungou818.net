...
<form name="myform" action="" method="post" enctype="multipart/form-data">
  <table width="100%" cellspacing="0">
  	 <tr>
		...
		<tr>
			<td align="right" style="width:120px"><font color="red">*</font>邀请绑定会员ID区间：</td>
			<td>
            <input type="text" id="q_begin" name="q_begin" value="<?php echo $member['q_begin']; ?>">--
            <input type="text" id="q_end" name="q_end" value="<?php echo $member['q_end']; ?>"> *空则不绑定
            </td>
		</tr>
		<tr>
