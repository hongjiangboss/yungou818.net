...
class group extends base {
	...
	public function showinsert(){	
		...
		if(isset($_POST['submit'])){		
			...
			//echo "INSERT INTO `@#_quanzi_tiezi`(`qzid`,`hueiyuan`,`title`,`neirong`,`zuihou`,`shenhe`,`time`)VALUES('$qzid','$uid','$title','$neirong','$uid','$shenhe','$time')";
			//echo "fdsf";exit;
			$inrel=$this->db->Query("INSERT INTO `@#_quanzi_tiezi`(`qzid`,`hueiyuan`,`title`,`neirong`,`zuihou`,`shenhe`,`time`)VALUES('$qzid','$uid','$title','$neirong','$uid','$shenhe','$time')");
			if($inrel){
