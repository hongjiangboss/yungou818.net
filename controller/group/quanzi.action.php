...
class quanzi extends admin {
	...
	public function insert(){
		if(isset($_POST["submit"]))
		{
			...
			$rel=$this->db->Query("INSERT INTO `@#_quanzi`(title,img,guanli,jianjie,gongao,jiaru,time,glfatie,huifu,shenhe)VALUES('$title','$img','$guanli','$jianjie','$gongao','$jiaru','$time','$glfatie','$huifu','$shenhe')");
			if($rel){
				_message("添加成功");
			}
		}
