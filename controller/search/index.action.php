...
class index extends SystemAction {
	...
	public function tag(){
		...
		$shoplist=$mysql_model->GetList("select title,thumb,id,sid,zongrenshu,canyurenshu,shenyurenshu,money from `@#_shoplist` WHERE shenyurenshu>0 and qishu<maxqishu and `title` LIKE '%".$search."%'");
		$list=count($shoplist);
