...
// 签名证书路径
const SDK_SIGN_CERT_PATH = './system/modules/pay/lib/unionpay_web/certs/PM_700000000000001_acp.pfx';

// 签名证书密码
 const SDK_SIGN_CERT_PWD = "vipcnt";// vipcnt
 
// // 验签证书（这条用不到的请随便配）
// const SDK_VERIFY_CERT_PATH = './system/modules/pay/lib/unionpay_web/certs/verify_sign_acp.cer';
 
// // 密码加密证书（这条用不到的请随便配）
// const SDK_ENCRYPT_CERT_PATH = './system/modules/pay/lib/unionpay_web/certs/verify_sign_acp.cer';

// 验签证书
const SDK_VERIFY_CERT_PATH = './system/modules/pay/lib/unionpay_web/certs/UpopRsaCert.cer';

// 密码加密证书
const SDK_ENCRYPT_CERT_PATH = './system/modules/pay/lib/unionpay_web/certs/RSA2048_PROD_index_22.cer';

// 验签证书路径
const SDK_VERIFY_CERT_DIR = './system/modules/pay/lib/unionpay_web/certs/';
