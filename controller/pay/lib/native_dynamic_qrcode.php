...
<head>
    <title>微信扫码支付</title>
	<link rel="stylesheet" type="text/css" href="<?php echo G_TEMPLATES_STYLE?>/pc/css/Comm_weixin.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo G_TEMPLATES_STYLE?>/pc/css/WeixinPay.css" />
...
<body>
    ...
    <div class="wx_header">
		<div class="wx_logo"><img title="微信支付" alt="微信支付标志" src="<?php echo G_TEMPLATES_STYLE?>/pc/images/wxlogo_pay.png" /></div>
    </div>
    <div class="weixin">
        <div class="weixin2">
            ...
            <div class="wx_box pngFix">
                    ...
                    <div class="pay_box qr_default">
                        <div class="area_bd"><span class="wx_img_wrapper"  id="qr_box">
                           ...
                           <div id="resmsgdiv"></div>
							<img style="left: 50%; opacity: 0; display: none; margin-left: -101px;" class="guide pngFix" src="<?php echo G_TEMPLATES_STYLE?>/pc/images/wxwebpay_guide.png" alt="" id="guide" />
                        </span>
                ...
                <div class="wx_money"><span>￥</span><?php echo $amount/100;?></div>
                ...
                <div class="wx_pay">
                    ...
                    <p><span class="wx_left">商品名称</span><span class="wx_right">818云购夺宝</span></p>
    ...
    <script>
        ...
        setInterval(function(){
          ...
          $.ajax({
            ...
            url:'<?php echo WEB_PATH;?>/pay/wxpay_url/getResultCode/',
            ...
            success: function(res){
                if(res.code==1){
                    window.location.href='<?php echo WEB_PATH;?>/pay/wxpay_url/qiantai/'+d+'/';
                }
            }             
          });           
