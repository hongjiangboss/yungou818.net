...
class RSA
{
	...
	public function __construct($conf)
	{
		...
		$this->_privFile = dirname(__FILE__).DIRECTORY_SEPARATOR.DIRECTORY_SEPARATOR.$items->item(0)->getElementsByTagName('pfx')->item(0)->nodeValue;
		$this->_pubFile = dirname(__FILE__).DIRECTORY_SEPARATOR.DIRECTORY_SEPARATOR.$items->item(0)->getElementsByTagName('cer')->item(0)->nodeValue;
