...
class WxPayConf_pub
{
    ...
    static $APPID = 'wx1a28191c4104aed1';
    //受理商ID，身份标识
    static $MCHID = '1345569001';
    //商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    static $KEY = 'qsc135wdv246ujywdfe4379ikyhUGR68';
    //JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
    static $APPSECRET = 'dfcfebab1e19e32b4952cc3c8a29bfa9';
    ...
    static $SSLKEY_PATH = 'http://yun.demo.wowcms.cn:8080/system/modules/pay/lib/wxpay/cacert/apiclient_key.pem';
