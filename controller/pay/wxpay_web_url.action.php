...
class wxpay_web_url extends SystemAction {
	...
	public function init() {
		...
		$config['NotifyUrl']  = G_WEB_PATH.'/pay/'.__CLASS__.'/houtai/';
    ...
    public function houtai(){
		...
		include_once dirname(__FILE__)."/lib/wxweb/WxPayPubHelper.php";
		...
		file_put_contents('wxpay_web_url.txt', json_encode($notify->data)."\n",FILE_APPEND);
		...
		if($up_q1 && $up_q2 && $up_q3){
			$this->db->Autocommit_commit();
				ActivityLotteryPayMoney($out_trade_no, $uid, $total_fee_t);	
		}else{
