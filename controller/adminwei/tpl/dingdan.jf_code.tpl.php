...
<!--start-->
		<?php
			...
			$shop = $this->db->GetOne("SELECT * FROM `@#_jf_shoplist` where `id`='$shopid'");
		...
		<div class="dingdan_content">
			...
			<li><b class="api_b">剩余数量：</b><?php echo $shop['shenyurenshu']; ?> 件	</li>
			<li><b class="api_b">总库存：</b><?php echo $shop['zongrenshu']; ?>件 	</li>
			<li><b class="api_b">价格：</b><?php echo $shop['yunjiage']; ?>元</li>
			<div class="bk10"></div>
			<li><b class="api_b">兑换数量：</b><?php echo $record['gonumber']; ?>人次</li>
		</div>
		<div class="bk10"></div>
