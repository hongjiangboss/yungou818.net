...
<script type="text/javascript" charset="utf-8" src="<?php echo G_TEMPLATES_PC_JS; ?>/area_city.js"></script>
...
<form name="myform" action="" method="post" enctype="multipart/form-data">
  <table width="100%" cellspacing="0">
		...
		<tr>
			...
			<td>
				<textarea id="qqurl" name="qqurl" class="input-text wid300" style="height:70px;"></textarea>
			</td>
		</tr>
		 <tr>
