...
<table width="100%" class="lr10">
    ...
    <td>权限</td>
        <td>
       <input type="radio" name="xitong" value="1" >系统权限|<input type="radio" name="yuny" value="1" >运营权限|<input type="radio" name="artic" value="1" >文章编辑|<input type="radio" name="shop" value="1" >商品编辑|<input type="radio" name="exchange" value="1" >积分购权限|<input type="radio" name="bus" value="1" >商户管理|<input type="radio" name="user" value="1" >用户管理|<input type="radio" name="tp" value="1" >界面权限|<input type="radio" name="pl" value="1" >插件权限|<input type="radio" name="guanli" value="1" >管理员权限|
        </td>
    </tr>
