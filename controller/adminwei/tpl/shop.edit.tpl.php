	...
	<table width="100%"  cellspacing="0" cellpadding="0">
    	<tr style="background-color:#FFe;height:50px;">
			...
			<td>
				...
				单次购买价格	<b style="color:red"><?php echo $shopinfo['yunjiage']; ?></b>&nbsp;&nbsp;&nbsp;
...
if($info['guanli']=='1'){?> 
		<tr>
			...
			<td>
            <input  type="text" id="quyu_begin" value="<?php echo $shopinfo['quyu_begin']; ?>" name="quyu_begin">--
            <input  type="text" id="quyu_end" value="<?php echo $shopinfo['quyu_end']; ?>" name="quyu_end"> *空表示不指定
...
<?php } ?>
         ...
         <tr>
			...
			<td>
            <input   type="text" id="ex_y" value="<?php echo $shopinfo['ex_y']; ?>" name="ex_y" >
            </td>
		</tr>
<!------20140901增加结束---------------->
        <tr>
		...
		<tr>
           ...
           <td>
            <input type="text" id="pv" value="<?php echo $shopinfo['pv']; ?>" name="pv" >
            </td>
		</tr>
		...
		<tr>
            ...
            <td width="900">
			 <input name="is_share" value="1" type="radio" <?php if($shopinfo['is_share']){echo "checked";} ?>/>&nbsp;是&nbsp;&nbsp;
			 <input name="is_share" value="0" type="radio" <?php if(!$shopinfo['is_share']){echo "checked";} ?>/>&nbsp;否&nbsp;&nbsp;
            </td>
        </tr>
