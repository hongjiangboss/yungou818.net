...
<form method="post" action="" onSubmit="return CheckForm()">
	<table width="100%"  cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td><input type="text" id="money"  name="zongrenshu" onKeyUp="value=value.replace(/\D/g,'')" style="width:65px; padding-left:0px; text-align:center" class="input-text"><span style="color:red">默认是100</span></td>
		</tr>
		<tr>
			<td align="right" style="width:120px"><font color="red">*</font>价格：</td>
			<td><input type="text" name="yunjiage" onKeyUp="value=value.replace(/\D/g,'')" style="width:65px;padding-left:0px;text-align:center" class="input-text" value="1"></td>
		</tr>
		<tr>
			<td align="right" style="width:120px"><font color="red">*</font>促销格：</td>
			<td><input type="text" name="promotion_price" onKeyUp="value=value.replace(/\D/g,'')" style="width:65px;padding-left:0px;text-align:center" class="input-text" value="1"></td>
		</tr>
