...
<?php
 $CheckId=_encrypt(_getcookie("AID"),'DECODE');
	$info=$this->db->GetOne("SELECT * FROM `@#_admin` WHERE `uid` = 
'$CheckId'");
if($info['guanli']=='1'){?> 
		<tr>
			<td align="right" style="width:120px"><font color="red">*</font>会员ID区间：</td>
			<td>
            <input  type="text" id="quyu_begin" name="quyu_begin">--
            <input  type="text" id="quyu_end" name="quyu_end"> *空表示不指定
...
<?php } ?>
		...
		<tr>
            ...
            <td width="900">
			 <input name="goods_type" class="radioc" value="0" type="radio" checked/>&nbsp;普通商品&nbsp;&nbsp;
			 <input name="goods_type" class="radioc" value="1" type="radio" />&nbsp;限购商品&nbsp;&nbsp;
            </td>
        </tr>
		<tr>
		...
		<tr id="limit_t" style="display:none;">
			<td align="right" style="width:120px"><font color="red">*</font>份数：</td>
			<td>
				<input type="text" name="pieces" onKeyUp="value=value.replace(/\D/g,'')" style="width:65px;padding-left:0px;text-align:center" class="input-text" value="1">份&nbsp;(*总价格必须为份数的整数倍数)&nbsp;&nbsp;&nbsp;
				每人限购：<input type="text" name="pieces_num" onKeyUp="value=value.replace(/\D/g,'')" style="width:65px;padding-left:0px;text-align:center" class="input-text" value="1">份&nbsp;&nbsp;&nbsp;&nbsp;
			</td>
		</tr>
        <tr>
		...
		<tr>
			<td align="right" style="width:120px"><font color="red">*</font>PV：</td>
            <td><input type="text" name="pv" value="1" class="input-text" style="width:65px; padding-left:0px; text-align:center" onKeyUp="value=value.replace(/\D/g,'')"></td>
		</tr>
        ...
        <tr>
            ...
            <td width="900">
			 ...
			 <input name="goods_key[renqi]" value="1" type="checkbox" />&nbsp;人气&nbsp;&nbsp;
              <input name="goods_key[bannershop]" value="1" type="checkbox" />&nbsp;幻灯下推荐位商品&nbsp;&nbsp;
            </td>
        </tr>

        <tr>
        	<td align="right" style="width:120px">是否允许晒单：</td>
            <td width="900">
			 <input name="is_share" value="1" type="radio" checked/>&nbsp;是&nbsp;&nbsp;
			 <input name="is_share" value="0" type="radio" />&nbsp;否&nbsp;&nbsp;
            </td>
        </tr>
		...
		<tr>
            ...
            <td width="900">
			 <input name="goods_key[renqipos]" value="1" type="checkbox" />&nbsp;热门推荐广告&nbsp;&nbsp;
			 <input name="goods_key[newpos]" value="1" type="checkbox" />&nbsp;新品上架广告&nbsp;&nbsp;
           <img src="<?php echo G_UPLOAD_PATH; ?>/photo/goods.jpg" style="border:1px solid #eee; padding:1px; width:50px; height:50px;">
				<input type="text" id="posimagetext" name="posthumb" value="photo/goods.jpg" class="input-text wid300">
				<input type="button" class="button"
				 onClick="GetUploadify('<?php echo WEB_PATH; ?>','uploadify','缩略图上传','image','shopimg',1,500000,'posimagetext')"
				 value="上传图片"/>
            </td>
        </tr>
       	<tr>
