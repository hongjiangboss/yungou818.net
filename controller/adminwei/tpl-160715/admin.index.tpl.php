...
<link id=cssfile rel=stylesheet type=text/css href="/data/plugin/style/images/skin_0.css">
...
<div id="left">
    ...
    <li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/setting/email">邮箱配置</a></li> 
		...
		<li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/qq_admin">官方QQ群</a></li>	
			<li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/setting/share">分享配置</a></li>
		<?php } ?>
