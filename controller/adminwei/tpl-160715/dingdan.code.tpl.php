...
<!--start-->
		<?php
			...
			if(!$shop['q_uid']){				
				...
				$qishu['ren']=get_user_name($shop['q_uid']);
		...
		<div class="dingdan_content">
			...
			<li><b class="api_b"><font color="#ff0000">中奖幸运码</font></b><?php echo $qishu['ma']; ?></li>	
			<div class="bk10"></div>
			<li><b class="api_b">购买次数：</b><?php echo $record['gonumber']; ?>人次</li>
			<li class="yun_ma"><b class="api_b">获得购买码：</b><br/>			
			<?php  
