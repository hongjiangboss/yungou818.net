...
<form name="myform" action="" method="post">
  <table width="100%" cellspacing="0">
		...
		<td>
			...
			<input type="radio" name="s_type" value="3" <?php echo ($type==3 ? 'checked' : ''); ?> /> <font color="#09c">只发微信</font> <br/>
			<input type="radio" name="s_type" value="4" <?php echo ($type==4 ? 'checked' : ''); ?> /> <font color="#09c">微信、邮件、短信</font> <br/>
		</td>
	</tr>
