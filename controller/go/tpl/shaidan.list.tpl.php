...
<div class="table-list lr10">
 <table width="100%" cellspacing="0">
	...
	<tr align="center" class="mgr_tr">
		...
		<td><?php if($v['grade']){echo $v['grade'];}else{echo "未评";}?></td>
		<td class="action"><?php if(!$v['grade'] || $v['grade']=='D'){?><span>[<a href="<?php echo G_MODULE_PATH;?>/shaidan_admin/check/<?php echo $v['sd_id'];?>">审核</a>]</span><?php }?><span>[<a onClick="shaidan(<?php echo $v['sd_id'];?>)" href="javascript:;">删除</a>]</span></td>
	</tr>
	<?php } ?>
    </tbody>
</table>
