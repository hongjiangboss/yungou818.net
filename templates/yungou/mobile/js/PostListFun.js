$(function() {
    ...
    var h = function() {
        ...
        var t = function() {
            p.hide();
            l.show();
            GetJPData("http://m.yygcms.com", "getPostPageList", r(),
            function(z) {
                if (z.code == 0) {
                    if (d.isCount == 1 && e == 10) {
                        s = z.count;
                    ...
                    for (var w = 0; w < y.length; w++) {
                        ...
                        B += '<dl class="fl"><a href="http://m.yygcms.com/userpage/' + y[w].userWeb + '"><img src="http://faceimg.yygcms.com/UserFace/' + y[w].userPhoto + '"><b></b></a></dl>';
                        ...
                        for (var v = 0; v < u.length; v++) {
                            B += '<img src="' + Gobal.LoadPic + '" src2="http://mimg.yygcms.com/userpost/small/' + u[v] + '" />'
                        }
                        B += "</li>";
                        ...
                        x.children("div.cSingleR").click(function() {
                            ...
                            f(C);
                            location.href = "http://m.yygcms.com/userpage/" + $(this).attr("uweb")
                        });
                        if (e == 10) {
                            A = d.EIdx;
                            b.append(x)
