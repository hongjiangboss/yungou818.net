$.fn.StartTimeOut = function(b) {
    var a = $(this);
    GetJPData("http://dataserver.yygcms.com", "GetCodeLotteryTimeOut", "codeid=" + b,
    function(v) {
        var i = v.Code;
        var k = v.Seconds;
        if (i == 0) {
            ...
            var e = function() {
                ...
                var x = null;
                var w = function() {
                    GetJPData("http://dataserver.yygcms.com", "getCodeState", "codeID=" + b,
                    function(y) {
                        if (y.Code == 0 && y.State == 3) {
                            location.replace("http://m.yygcms.com/Lottery/detail-" + b + ".html")
                        }
                    })
                };
