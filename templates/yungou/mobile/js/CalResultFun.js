$(function() {
    ...
    var e = false;
    var a = $("#btnCalMethod");
    var d = '<div class="infoRule"><p><em>01</em>取该商品最后购买时间前网站所有商品的最后100条购买时间记录；</p><p><em>02</em>每个时间记录按时、分、秒、毫秒依次排列取数值；</p><p><em>03</em>将这100个数值之和除以该商品总参与人次后取余数，余数加上10000001 即为“幸运码”。</p><b class="z-arrow"></b></div>';
    var f = function(i) {
    ...
    $("div.h5-yygcms-v1").click(function() {
        if (b) {
