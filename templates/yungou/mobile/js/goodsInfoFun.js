$(function() {
    ...
    if (m) {
        ...
        Base.getScript(Gobal.Skin + "/mobile/js/GoodsTimeFun.js",
        function() {
        ...
        var jf = function(r) {
            GetJPData(Gobal.Webpath, "ajax", "jf_addShopCart/" + p + "/" + 1,
            function(s) {
                if (s.code == 0) {
                    if (r == 0) {
                        addNumToCartFun(s.num);
                        ...
                        location.href = Gobal.Webpath+"/mobile/cart/jf_cartlist"
                    }
                } else {
                    if (r == 0) {
                        d("添加失败")
        ...
        $("#btnBuyBox1").children("a").eq(0).click(function() {
            jf(1)
        });
        Base.getScript(Gobal.Skin + "/mobile/js/pageDialog.js", i);
        var g = $("#divAutoRTime");
        if (g.length > 0) {
            var o = g.attr("time");
            if (o) {
                ...
                Base.getScript(Gobal.Skin + "/mobile/js/CountdownFun.js",
                function() {
                    g.countdowntime(e, k)
                });
				//获取当前商品
    ...
    var a = function() {
        ...
        Base.getScript(Gobal.Skin + "/mobile/js/GoodsPicSlider.js?v=130826",
        function() {
            $("#sliderBox").picslider()
        })
    };
    Base.getScript(Gobal.Skin + "/mobile/js/PeriodSlider.js?v=130826", a)
});