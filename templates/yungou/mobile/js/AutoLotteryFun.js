$(document).ready(function() {
    var a = function() {
        ...
        if (f.length > 0) {
            ...
            Base.getScript(Gobal.Skin + "/mobile/js/CountdownFun.js", e)
        }
        ...
        Base.getScript(Gobal.Skin + "/mobile/js/pageDialog.js", g);
        var d = function() {
        ...
        Base.getScript(Gobal.Skin + "/mobile/js/Flexslider.js", d)
    };
    a()
});