            ...
            var w = function() {
                ...
                function(D) {
                    if (D.code == 0) {
                        ...
                        for (var y = 0; y < B; y++) {
                            var z = 2;
                            var x = z == 2 ? Gobal.Webpath+"/mobile/shaidan/detail/" + C[y].sd_id + "": Gobal.Webpath+"/mobile/home/PostSingleEdit/" + C[y].id + "";
            ...
            var w = function() {
                ...
                function(B) {
                    if (B.code == 0) {
                        ...
                        for (var x = 0; x < z; x++) {
                            var C = '<li class="' + (x + 1 == z ? "bornone": "") + '" id="' + A[x].id + '" rid="' + A[x].rid + '" onclick="location.href=\'' + Gobal.Webpath + '/mobile/home/postsingle/' + A[x].rid + '/\'"><a class="fl z-Limg" href="'+Gobal.Webpath+'/mobile/home/postsingle/' + A[x].rid + '/" class="gray6"><img src="' + Gobal.LoadPic + '" src2="'+Gobal.imgpath+'/uploads/' + A[x].thumb + '" border=0 alt=""></a><div class="u-sgl-r gray9"><p class="z-sgl-tt"><a href="'+Gobal.Webpath+'/mobile/home/postsingle/' + A[x].rid + '/" class="gray6">' + A[x].title + "</a></p><p>幸运码：" + A[x].q_user_code + "</p><p>揭晓时间：" + A[x].q_end_time + '</p><p><a href="#" class="z-sgl-btn"></a></p></div><b class="z-arrow"></b></li>';
                            var y = $(C);
                            s.append(y)
                        }
